...
///   PhysicsObject
const Vector3d& PhysicsObject::get_position(){ return position; }
const Vector3d& PhysicsObject::get_velocity(){ return velocity; }
const Vector3d& PhysicsObject::get_acceleration(){ return acceleration; }
const double& PhysicsObject::get_mass(){ return mass; }
const double& PhysicsObject::get_charge(){ return charge; }
